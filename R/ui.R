        ...
        tabsetPanel(type="tabs", id = "predictTabs",
            ...
            tabPanel("Manual Prediction",
                     fluidRow(box(title=strong("Denovo"), width=12,
                                  ...
                                  your patient MACE with customized features you selected in 'Features' box",br(), br(),
                                  actionButton(inputId = "man_predict", label = "Manual Prediction",
                              ...
                              column(6,
                                    ...
                                    radioButtons(inputId = "Statines", label="Statines", 
                                                 choices = c("No", "Yes"), selected = "No", inline=T),
                                    radioButtons(inputId = "COPD", label="COPD", choices = c("No", "Yes"),
                                                 selected = "No", inline=T),
                                    radioButtons(inputId = "ASA", label="ASA", choices = c("No", "Yes"),
                                                 selected = "No", inline = T),
                                    ...
                                    radioButtons(inputId = "Block", label = "Block",
                                                 choices = c("First degree AVB", "LBBB", "No", "RBBB"), 
                                                 selected = "No",inline = T),
